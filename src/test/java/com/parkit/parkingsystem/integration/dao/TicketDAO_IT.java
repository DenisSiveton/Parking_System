...
public class TicketDAO_IT {
    ...
    public void saveTicket_databaseShouldHaveOneTicketSavedWithProperRegNumber() {
        ...
        String regNumberOfTicket = returnRegNumberOfTicketWithFollowingRegNumber(TEST_REG_NUMBER);
    ...
    public void updateTicket_databaseShouldReturnOutTimeOfTicketWithValueNotNull() {
        ...
        Date result = returnOutTimeOfTicketWithFollowingRegNumber(TEST_REG_NUMBER);
        //ASSERT
    ...
    private String returnRegNumberOfTicketWithFollowingRegNumber(String regNumber) {
        Connection con = null;
    ...
    private Date returnOutTimeOfTicketWithFollowingRegNumber(String regNumber) {
        Connection con = null;
        Date outTime = new Date();
        try {
            con = ticketDAO.dataBaseConfig.getConnection();
